...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(844, 688)
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(330, 30, 211, 61))
        font = QtGui.QFont()
